...
<div class="form-group">
    ...
    <input type="text" class="form-control category-display" value="<?php echo $bkcateg ?>" style="width: 40%" disabled>
    <input type="hidden" name="category" id="10a" data-original="<?php echo $bkcateg ?>" value="<?php echo $bkcateg ?>">
    <a href="#" onclick="editCategory()">Change</a> | <a href="#" onclick="resetCategory()">Reset</a>
</div>
<div class="form-group" id="10f" style="display: none">
    <label style="font-size:15px;">New Category</label>
    <select class="form-control" id="edit-category-type-select">
